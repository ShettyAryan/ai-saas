...
const StepItem = ({ icon, label, description }: Step) => {
  return (
    <div className="relative p-6 rounded-2xl bg-white/5 backdrop-blur-xs border-2 border-white/10 hover:border-emerald-500/50 transition-colors group w-full ">
      <div className="flex flex-col gap-4 h-full">
        <div className="flex items-center justify-center h-24 w-24 mx-auto rounded-2xl bg-linear-to-br from-emerald-500/10 to-transparent group-hover:from-emerald-500/20 transition-colors">
      ...
      <div className="py-12 lg:py-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <MotionH2
            ...
            className="font-bold text-xl uppercase mb-4 text-emerald-500"
          >
            How it works
          </MotionH2>
          <MotionH3
          ...
          >
            Transform any PDF into an easy-to-understand summary in three simple
            steps
          </MotionH3>
        </div>
            ...
            >
              ...
              {index < steps.length - 1 && (
                <MotionDiv
                  ...
                  className="hidden md:block absolute top-1/2 -right-4 transfrom -translate-y-1/2 z-10"
                >
                  <MoveRight
                    size={32}
                    strokeWidth={1}
