...
const UploadHeader = () => {
  return (
    <div className="flex flex-col items-center justify-center gap-6 text-center">
      ...
      <MotionDiv className="capitalize text-4xl font-bold tracking-tight text-gray-900 sm:text-4xl">
        Start uploading{" "}
      ...
      <MotionDiv className="mt-2 text-lg leading-8 text-gray-600 max-w-2xl text-center">
