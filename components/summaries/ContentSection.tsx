import { parseEmojiPoints, parsePoint } from "@/utils/summaryHelper";
  ...
  return (
    <div className="group relative bg-linear-to-br from-gray-200/[0.08] to-gray-400/[0.03] p-4 rounded-2xl border border-gray-500/10 hover:shadow-lg transition-all">
      ...
      <div className="relative flex items-start gap-3">
        ...
        <p className="text-lg lg:text-xl flex-1 text-muted-foreground/90 leading-relaxed break-words">
          {text}
        </p>
      </div>
    </div>
...
const RegularPoint = ({ point }: { point: string; index: number }) => {
  return (
    <div className="group relative bg-linear-to-br from-gray-200/[0.08] to-gray-400/[0.03] p-4 rounded-2xl border border-gray-500/10 hover:shadow-lg transition-all">
      ...
      <p className=" relative text-lg lg:text-xl flex-1 text-muted-foreground/90 leading-relaxed break-words text-left">
        {point}
      </p>
    </div>
  );
